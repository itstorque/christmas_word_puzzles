...
(self.webpackChunk_xwords_phoenix = self.webpackChunk_xwords_phoenix || []).push([[9336], {
    21824: function(e, t, n) {
        ...
        const o = "position"
          ...
          , E = () => {
            const e = document.getElementById("js-hoook-pz-moment__game");
          ...
          , O = e => {
            (0,
            r.Dc)(_).then(( () => {
                const t = document.getElementById("js-hoook-pz-moment__".concat(e)).querySelector(".".concat(f));
          ...
          , C = (e, t, n, E) => {
            ...
            //  && (b(document.body, l, e.style.backgroundColor || "var(--bg-page, white)"),
    ...
    82795: function(e, t, n) {
        ...
        function Te(e) {
            ...
            const m = r.useRef(document.getElementById("aaa"))
              , p = (0,
            a.v9)(n)
              , f = (0,
            a.v9)(t)
        ...
        const on = () => {
            ...
            (0,
            r.useEffect)(( () => {
                l && _ && window.location.replace("/christmas_word_puzzles/nyt_games/leaderboard".concat(e ? "?GAMES_connectionsRollout_1130=1_ConnectionsV2" : ""))
            }
            ), [l, _]);
        ...
        t.Z = () => {
            ...
            return {
                ...
                trackConnectionsImpression: (t, n) => {
                    (0,
                    o.hX)(t, "leaderboard", n, e.toString())
                }
            }
        }
    },
